...
const docPages = [
  {
    path: "two-step-guide",
    title: "Two step guide",
    markdownSrc: "docs/two-step-guide.md"
  },
  {
    path: "configuring-majestic",
    title: "Configuring majestic",
    markdownSrc: "docs/configuring-majestic.md"
  },
  {
    path: "run-as-an-app",
    title: "Run as a app",
    markdownSrc: "docs/run-as-an-app.md"
  },
  {
    path: "debugging-in-vs-code",
    title: "Debugging in VS Code",
    markdownSrc: "docs/debugging-in-vs-code.md"
  },
  {
    path: "contributing",
    title: "Contributing",
    markdownSrc: "docs/contributing.md"
  }
];
